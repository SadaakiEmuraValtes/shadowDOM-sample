    ...
    this._shadow.innerHTML = `
      <style>
        * { box-sizing: border-box; }
        ...
        .pub-table th, .pub-table td { padding: 8px 12px; border-bottom: 1px solid #f1f5f9; text-align: left; }
        .pub-table th { width: 120px; color: #64748b; font-weight: 600; }
        .pub-table td { color: #1e293b; }

        /* 書籍紹介 */
        .description { font-size: .92rem; color: #374151; line-height: 1.8; }
      ...
      <div class="section-card">
        ...
        <div class="description" data-testid="detail-description">${meta.description}</div>
      </div>

      <!-- 発行情報 -->
      <div class="section-card">
        <div class="section-title">📋 発行情報</div>
        <table class="pub-table" data-testid="detail-pub-table">
          <tr><th>書名</th><td data-testid="detail-pub-title">${book.title}</td></tr>
          <tr><th>著者</th><td data-testid="detail-pub-author">${book.author}</td></tr>
          <tr><th>ジャンル</th><td>${book.genre}</td></tr>
          <tr><th>初版発行年</th><td data-testid="detail-pub-year">${meta.year} 年</td></tr>
          <tr><th>出版社</th><td data-testid="detail-pub-publisher">${meta.publisher}</td></tr>
          <tr><th>ページ数</th><td data-testid="detail-pub-pages">${meta.pages} ページ</td></tr>
          <tr><th>所蔵冊数</th><td>${book.stock} 冊（貸出可: ${available} 冊）</td></tr>
        </table>
      </div>
